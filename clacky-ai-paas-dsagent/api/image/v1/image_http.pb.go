...
const OperationImageServiceECRLogin = "/image.v1.ImageService/ECRLogin"
const OperationImageServiceECRLogout = "/image.v1.ImageService/ECRLogout"
...
type ImageServiceHTTPServer interface {
	// ECRLogin Login to ECR registry
	ECRLogin(context.Context, *ECRLoginRequest) (*ECRLoginResponse, error)
	// ECRLogout Logout from ECR registry
...
func RegisterImageServiceHTTPServer(s *http.Server, srv ImageServiceHTTPServer) {
	...
	r.POST("/v1/ecr/login", _ImageService_ECRLogin0_HTTP_Handler(srv))
	r.POST("/v1/ecr/logout", _ImageService_ECRLogout0_HTTP_Handler(srv))
}
...
func _ImageService_ECRLogin0_HTTP_Handler(srv ImageServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationImageServiceECRLogin)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ECRLogin(ctx, req.(*ECRLoginRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _ImageService_ECRLogout0_HTTP_Handler(srv ImageServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationImageServiceECRLogout)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ECRLogout(ctx, req.(*ECRLogoutRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type ImageServiceHTTPClient interface {
	ECRLogin(ctx context.Context, req *ECRLoginRequest, opts ...http.CallOption) (rsp *ECRLoginResponse, err error)
	ECRLogout(ctx context.Context, req *ECRLogoutRequest, opts ...http.CallOption) (rsp *ECRLogoutResponse, err error)
...
func (c *ImageServiceHTTPClientImpl) ECRLogin(ctx context.Context, in *ECRLoginRequest, opts ...http.CallOption) (*ECRLoginResponse, error) {
	var out ECRLoginResponse
	pattern := "/v1/ecr/login"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationImageServiceECRLogin))
...
func (c *ImageServiceHTTPClientImpl) ECRLogout(ctx context.Context, in *ECRLogoutRequest, opts ...http.CallOption) (*ECRLogoutResponse, error) {
	var out ECRLogoutResponse
	pattern := "/v1/ecr/logout"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationImageServiceECRLogout))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
