...
const (
	...
	ImageService_ECRLogin_FullMethodName     = "/image.v1.ImageService/ECRLogin"
	ImageService_ECRLogout_FullMethodName    = "/image.v1.ImageService/ECRLogout"
)
...
type ImageServiceClient interface {
	...
	ECRLogin(ctx context.Context, in *ECRLoginRequest, opts ...grpc.CallOption) (*ECRLoginResponse, error)
	// Logout from ECR registry
	ECRLogout(ctx context.Context, in *ECRLogoutRequest, opts ...grpc.CallOption) (*ECRLogoutResponse, error)
}
...
func (c *imageServiceClient) ECRLogin(ctx context.Context, in *ECRLoginRequest, opts ...grpc.CallOption) (*ECRLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ECRLoginResponse)
	err := c.cc.Invoke(ctx, ImageService_ECRLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *imageServiceClient) ECRLogout(ctx context.Context, in *ECRLogoutRequest, opts ...grpc.CallOption) (*ECRLogoutResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ECRLogoutResponse)
	err := c.cc.Invoke(ctx, ImageService_ECRLogout_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ImageServiceServer interface {
	...
	// Login to ECR registry
	ECRLogin(context.Context, *ECRLoginRequest) (*ECRLoginResponse, error)
	// Logout from ECR registry
	ECRLogout(context.Context, *ECRLogoutRequest) (*ECRLogoutResponse, error)
...
func (UnimplementedImageServiceServer) ECRLogin(context.Context, *ECRLoginRequest) (*ECRLoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ECRLogin not implemented")
}
func (UnimplementedImageServiceServer) ECRLogout(context.Context, *ECRLogoutRequest) (*ECRLogoutResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ECRLogout not implemented")
}
...
func _ImageService_ECRLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ECRLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImageServiceServer).ECRLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ImageService_ECRLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImageServiceServer).ECRLogin(ctx, req.(*ECRLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ImageService_ECRLogout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ECRLogoutRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImageServiceServer).ECRLogout(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ImageService_ECRLogout_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImageServiceServer).ECRLogout(ctx, req.(*ECRLogoutRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ImageService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ECRLogin",
			Handler:    _ImageService_ECRLogin_Handler,
		},
		{
			MethodName: "ECRLogout",
			Handler:    _ImageService_ECRLogout_Handler,
		},
	},
